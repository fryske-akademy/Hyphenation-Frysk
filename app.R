  ...
  (
    ...
    (
      ...
      (
        ...
        p(HTML("Heeringa, Wilbert (2025). Hyphenation Frysk [computer program]. Retrieved 27 June 2025 from <span style='font-family: \"Lucida Console\", \"Menlo\", \"Monaco\", \"Courier\", monospace;'>https://www.fa.knaw.nl/fa-apps/Hyph/</span>.")),
        br(),
...
server <- function(input, output, session)
{
  ...
  graph2phon <- function(ud)
  {
    ...
    p <- unlist(system(command = paste0("/opt/venv/bin/phonetisaurus predict --model /srv/shiny-server/www/hyph.fst --casing ignore ", p), intern = TRUE))
